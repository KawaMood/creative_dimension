...
data modify entity @e[type=area_effect_cloud,tag=pk_cr_di_to_init,limit=1] effects set from entity @e[type=marker,tag=pk_cr_di_current_player_data,limit=1] data.active_effects
