...
tag @p[tag=pk_player_leave_dimension] add pk_crea_wait_returning_animation
# Apply animation after teleporation (need to wait for 1 tick)
schedule function pk_crea:player/in_creative_dimension/leave/schedule_gateway_returning_animation 1t