...
execute if items entity @s container.* player_head[custom_data~{pk_data:{id:"pot_al",from:"creative_dimension"}},!custom_data~{pk_data:{version:30106s}}] run function pk_cr_di:items/pot_al/update/run {version:30106s}
